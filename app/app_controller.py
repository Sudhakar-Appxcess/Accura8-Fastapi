...
def register_controller(app):
    ...
    api_router.include_router(sql_migration_router, prefix="/sql-m", tags=["SQL Migrations"])
    api_router.include_router(code_converter_router, prefix="/code", tags=["Code Converter"])
    api_router.include_router(nl_to_sql_router, prefix="/sql-n", tags=["Natural Language to SQL"])
